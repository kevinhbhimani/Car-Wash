/**
 * The KQueue interface specifies the methods for a <i>queue</i> data structure.
 * <ul>
 * <li>The enqueue method adds an element to the "back" of the data structure.
 * <li>The dequeue method acts as follows:
 * <ul>
 * <li>If the queue is empty, an exception is thrown.
 * <li>If the queue contains one element, dequeue returns that element, leaving
 * the queue empty.
 * <li>If the queue contains multiple elements, dequeue returns the element at
 * the "front" of the queue, the one that has been there longest.
 * </ul>
 * </ul>
 * 
